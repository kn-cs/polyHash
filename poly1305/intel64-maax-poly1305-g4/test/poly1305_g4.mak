...
SRCFLS = ../source/poly1305_const.S 		\
	 ../source/poly1305_maax_g4.S		\
	 ../source/poly1305_keypowers.S	\
	 ../source/poly1305_input.c 		\
	 ../source/poly1305.c
         
OBJFLS = ../source/poly1305_const.o 		\
	 ../source/poly1305_maax_g4.o		\
	 ../source/poly1305_keypowers.o	\
	 ../source/poly1305_input.o 		\
	 ../source/poly1305.o

TESTSRC = ./poly1305_g4_verify.c
TESTOBJ = ./poly1305_g4_verify.o

SPEEDSRC = ./poly1305_g4_speed.c
SPEEDOBJ = ./poly1305_g4_speed.o

RECORDSRC = ./poly1305_g4_record_speed.c
RECORDOBJ = ./poly1305_g4_record_speed.o
	  
EXE1    = poly1305_g4_verify
EXE2    = poly1305_g4_speed
EXE3    = poly1305_g4_record_speed
