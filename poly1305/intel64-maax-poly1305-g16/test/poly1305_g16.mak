...
SRCFLS = ../source/poly1305_const.S 		\
	 ../source/poly1305_maax_g16.S	\
	 ../source/poly1305_keypowers.S	\
	 ../source/poly1305_input.c 		\
	 ../source/poly1305.c
         
OBJFLS = ../source/poly1305_const.o 		\
	 ../source/poly1305_maax_g16.o	\
	 ../source/poly1305_keypowers.o	\
	 ../source/poly1305_input.o 		\
	 ../source/poly1305.o

TESTSRC = ./poly1305_g16_verify.c
TESTOBJ = ./poly1305_g16_verify.o

SPEEDSRC = ./poly1305_g16_speed.c
SPEEDOBJ = ./poly1305_g16_speed.o

RECORDSRC = ./poly1305_g16_record_speed.c
RECORDOBJ = ./poly1305_g16_record_speed.o
	  
EXE1    = poly1305_g16_verify
EXE2    = poly1305_g16_speed
EXE3    = poly1305_g16_record_speed
