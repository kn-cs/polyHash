...
SRCFLS = ../source/poly1271_const.S 		\
	 ../source/poly1271_maax_g1.S		\
	 ../source/poly1271_input.c 		\
	 ../source/poly1271.c
         
OBJFLS = ../source/poly1271_const.o 		\
	 ../source/poly1271_maax_g1.o		\
	 ../source/poly1271_input.o 		\
	 ../source/poly1271.o

TESTSRC = ./poly1271_g1_verify.c
TESTOBJ = ./poly1271_g1_verify.o

SPEEDSRC = ./poly1271_g1_speed.c
SPEEDOBJ = ./poly1271_g1_speed.o

RECORDSRC = ./poly1271_g1_record_speed.c
RECORDOBJ = ./poly1271_g1_record_speed.o
	  
EXE1    = poly1271_g1_verify
EXE2    = poly1271_g1_speed
EXE3    = poly1271_g1_record_speed
