...
int main(int argc, char **argv) {
	...
	MEASURE_TIME({poly1271(h,m,k,l);change_input(m,h,k);});
	fprintf(FILE,"CPU-cycles per byte for computing poly1271 using sl-maax type computation on a message of length %llu bits: %6.4lf\n\n", l,((get_median())/(double)(n*N)));
	#endif
