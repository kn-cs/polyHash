...
SRCFLS = ../source/poly1271_const.S 		\
	 ../source/poly1271_maax_g8.S		\
	 ../source/poly1271_keypowers.S	\
	 ../source/poly1271_input.c 		\
	 ../source/poly1271.c
         
OBJFLS = ../source/poly1271_const.o 		\
	 ../source/poly1271_maax_g8.o		\
	 ../source/poly1271_keypowers.o	\
	 ../source/poly1271_input.o 		\
	 ../source/poly1271.o

TESTSRC = ./poly1271_g8_verify.c
TESTOBJ = ./poly1271_g8_verify.o

SPEEDSRC = ./poly1271_g8_speed.c
SPEEDOBJ = ./poly1271_g8_speed.o

RECORDSRC = ./poly1271_g8_record_speed.c
RECORDOBJ = ./poly1271_g8_record_speed.o
	  
EXE1    = poly1271_g8_verify
EXE2    = poly1271_g8_speed
EXE3    = poly1271_g8_record_speed
